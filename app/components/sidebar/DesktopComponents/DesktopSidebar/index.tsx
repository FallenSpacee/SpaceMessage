...
const DesktopSidebar: FC<DesktopSidebarProps> = ({currentUser}) => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-20 xl:px-6 lg:overfow-y-auto lg:bg-purple-200 lg:border-r-[1px] lg:pb-4 lg:flex lg:flex-col justify-between">
